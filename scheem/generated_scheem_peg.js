  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_integer() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, negative) { return -negative; })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_expression() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, quote) { return ["quote", quote]; })(pos0.offset, pos0.line, pos0.column, result0[1]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
